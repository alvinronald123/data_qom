...
function redirectBasedOnScreenSize() {
    ...
    console.log("Window width:", windowWidth); // Debugging output

    // Check if the window width is less than the threshold
    if (windowWidth < mobileScreenWidthThreshold) {
        console.log("Redirecting to mobile.php"); // Debugging output
        // Redirect to mobile.php for smaller screens
        window.location.href = 'mobile.php';
    } else {
        console.log("Redirecting to userdashboard.php"); // Debugging output
