...
<head>
    ...
    <style>
        * {
        ...
        .social-media {
            background: linear-gradient(#252a4a70, #202342dc), url(./images/one.png);
...
<body class = "">
    ...
    <div class="green round spacing fixed-color">
        <h1><?php echo $staff ?>.00</h1>
        <p class="dull">Active Old Student(s)</p>
    </div>
    <div class="purple round spacing fixed-color">
        <h1><?php echo $clients ?>.00</h1>
        <p class="dull">Old Student(s)</p>
    </div>
    <div class="main-div round v-align">
        ...
        <div class="line">
            <p class="dull spacing text-center">Mail Deliveries per Old Student</p>
            <canvas id="line"></canvas>
        </div>
    </div>
    <div class="employees spacing round overlay-scroll">
            <p class="dull spacing">All Old Students</p>
    </div>
    <script>
