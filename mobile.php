<?php
include ("old_student_database.php");
...
input[type=file]::-webkit-file-upload-button {
    ...
    .trim {
        ...
        .edit-profile .show-table {
            display: flex;
            font-size: 20px;
        }
       table tr td  .input .extra{
            width: 100%;
            flex-direction: column;
...
<div class="sidebar" id="sidebar">
    ...
    <div class="c-right">
        ...
        <form class="edit-profile mine" action="updateuser.php" enctype="multipart/form-data" method="post" onsubmit="updateform()">
            <table cellspacing='10'>
                <tr>
                    ...
                    <td>
                        <input type="text" class="input extra" placeholder=" username" name='staffname'id = 'username'>
                    </td>
                    <td>
                        Date Of Birth
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input style="width: 350px;" type="password" class="input extra" id="pass" name="staffpass">
        ...
        <!----- Sign up form-------->
        <form style="display: flex; height:400px;  max-height: 800px;overflow: auto; margin-top:200px; margin-bottom:100px;" class="edit-profile" action="old_student_database.php" enctype="multipart/form-data" method="post" onsubmit="updateforms(event)">
             
            <table style="flex-direction: column; max-height: 800px;overflow: auto; margin-top:200px; margin-bottom:100px; " id="myTable" cellspacing='10'>
                <tr>
                    <td>
                        Name
                ...
                <td>
                    Gender
                    <input  type="text" class="input extra" placeholder="gender" name="gender" id="gender"></td>
                    </tr>
...
function getMessages(){
    ...
    <div class="messages">
        ...
        <div class="compose">
            <div style="width:250px;  overflow: auto;" class="message-compose">
...
<div class="mails">
    ...
    <p>Name </p>
        <p>Message</p>
        <p>Date </p>
        <p style=" margign-left:10px;"> Mark delivered</p>
    </div>
