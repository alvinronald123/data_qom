...
.box {
    ...
    margin: 10px;
    display: inline-block; /* Display divs inline, adjust as needed */
}
.special-div {
    background-color: #36A7FD;
    clear: both; /* Clear the float to move below other divs */
}
...
.details-container .form-container h2{
    text-align: center;
    align-items: center;
    justify-content: center;
    color:#337ab7;
...
.btns {
  ...
  .welcome{
    align-items: center;
    text-align: center;
    background-color: rgb(64, 161, 64);
    color: #382f2f;
    margin-left: 50px;
    margin-right: 50px;
    padding: 10px;
  ...
  .welcome:hover{
    color: #ddd;
    background-color: rgb(117, 92, 59);
  }
...
<body class = "">
    <div class='sidebar pointer'>
        ...
        <div style=" width:1090px; margin-left:10px; max-height:500px; " >
          
  <div class="details-container">
    <!-- Student details here -->
    <div class="form-container">
        <br>
    <h2 style="color: black;" >THE OLD STUDENT SHEET</h2>
        <br>
        <hr>
    <p style="color: black;" class="paragraphy"><h3 style="color: black;" > QUEEN OF MARTYRS OLD STUDENTS </h3></p>
    <hr>
    <br>
    <div class="container">
    ...
    <table style="color: black;">
        ...
        $sql = "SELECT * FROM old_student_databse"; // Replace 'old_student_database' with your actual table name
    ...
    <div class="navbar h-align">
        <div style="margin-top: 10px;" class="search h-align spacing full-round">
        ...
        <div style="margin-right: 10px;" class="h-align">
           ...
           <div style="margin-left: 50px;" class="logout h-align" onClick = "logout()">
...
const myFirstChart = new Chart(firstChart, {
    ...
    options: {
        ...
        .then((res)=>res.json())
        .then((data)=>{
            const secondChart = document.getElementById("line")
            .getContext("2d");
